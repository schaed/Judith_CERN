...
xmin1=-xmax/2
xmax1=xmax/2
xmax=xmax1-bin_width
xmin=xmin1+bin_width
h1 = ROOT.TH1F('statsys','statsys',int(nbins),xmin1,xmax1)
hstat = ROOT.TH1F('stat','stat',int(nbins),xmin1,xmax1)
i=0
x=ROOT.Double(-10000)
y=ROOT.Double(0)
y1=ROOT.Double(0)
...
line = ROOT.TLine(xmin1,1.0,xmax1,1.0)
line.SetLineWidth(3)
line.SetLineColor(1)
line.Draw()
...
lineelec2.Draw()
l = ROOT.TLatex(0.18, 0.95, 'Pixel Center')
l.SetNDC()
l.SetTextFont(72)
l.SetTextSize(0.045)
l.SetTextColor(2)
...
l2 = ROOT.TLatex(0.7, 0.95, 'Pixel Center')
l2.SetNDC()
l2.SetTextFont(72)
