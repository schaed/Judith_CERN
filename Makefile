...
SRCPATH = src
EXECUTABLE = Judith
OBJECTS = $(OBJPATH)/configparser.o $(OBJPATH)/inputargs.o $(OBJPATH)/main.o $(OBJPATH)/clusterinfo.o $(OBJPATH)/configanalyzers.o $(OBJPATH)/correlation.o $(OBJPATH)/depiction.o $(OBJPATH)/dualanalyzer.o $(OBJPATH)/dutcorrelation.o $(OBJPATH)/dutdepiction.o $(OBJPATH)/dutresiduals.o $(OBJPATH)/efficiency.o $(OBJPATH)/eventinfo.o $(OBJPATH)/exampledualanalyzer.o $(OBJPATH)/examplesingleanalyzer.o $(OBJPATH)/hitinfo.o $(OBJPATH)/matching.o $(OBJPATH)/occupancy.o $(OBJPATH)/residuals.o $(OBJPATH)/singleanalyzer.o $(OBJPATH)/syncfluctuation.o $(OBJPATH)/trackinfo.o $(OBJPATH)/kartelconvert.o $(OBJPATH)/analysis.o $(OBJPATH)/analysisdut.o $(OBJPATH)/applymask.o $(OBJPATH)/chi2align.o $(OBJPATH)/coarsealign.o $(OBJPATH)/coarsealigndut.o $(OBJPATH)/configloopers.o $(OBJPATH)/examplelooper.o $(OBJPATH)/finealign.o $(OBJPATH)/finealigndut.o $(OBJPATH)/looper.o $(OBJPATH)/noisescan.o $(OBJPATH)/processevents.o $(OBJPATH)/synchronize.o $(OBJPATH)/synchronizerms.o $(OBJPATH)/synchronizeBunchXing.o $(OBJPATH)/alignment.o $(OBJPATH)/configmechanics.o $(OBJPATH)/device.o $(OBJPATH)/noisemask.o $(OBJPATH)/sensor.o $(OBJPATH)/clustermaker.o $(OBJPATH)/configprocessors.o $(OBJPATH)/eventdepictor.o $(OBJPATH)/largesynchronizer.o $(OBJPATH)/processors.o $(OBJPATH)/synchronizer.o $(OBJPATH)/trackmaker.o $(OBJPATH)/trackmatcher.o $(OBJPATH)/cluster.o $(OBJPATH)/event.o $(OBJPATH)/hit.o $(OBJPATH)/plane.o $(OBJPATH)/storageio.o $(OBJPATH)/track.o 
all: Judith
...
$(OBJPATH)/synchronizeBunchXing.o: $(SRCPATH)/loopers/synchronizeBunchXing.cpp
	$(CC) $(CFLAGS) -c $(SRCPATH)/loopers/synchronizeBunchXing.cpp -o $(OBJPATH)/synchronizeBunchXing.o
