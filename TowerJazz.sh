...
#export ALIG=$PATHA/cosmic_033214_000000.root
export ALIG=$PATHA/cosmic_033217_000000.root
#export ALIG=$PATHA/cosmic_033189_000000.root
...
#export DUT=$PATHA/run_33216_tj_W3R15_M106_6V_3DRS_fft12
#export DUT=$PATHA/run_33038_tj_W3R13_50um_6V_3DRS_fft
#export DUT=$PATHA/run_33192_tj_W3R15_M129_6V_3DRS_fft10
#export DUT=$PATHA/run_33118_tj_W3R15_M129_6V_3DRS_40k
#export DUT=$PATHA/run_33118_tj_W3R15_M129_6V_3DRS_fft10
export DUT=$PATHA/run_33219_tj_W3R15_M106_6V_3DRS_fft9
...
#export RCE=$PATHA/cosmic_033216_000000
#export RCE=$PATHA/cosmic_033192_000000
...
#./Judith -c synchronizeBunchXing -i ${RCE_MASKED}.root -o ${RCE_MASKED}_sync.root -I $DUT.root -O ${DUT}_sync.root -r $TELECONF -d configs/$DUTCONFIG -t configs/globalorig_TowerJazz.cfg -s 0 #-s 10000
...
#echo "-------------------FineAlign dut"
./Judith -c fineAlignDUT -i ${RCE_MASKED}.root -I ${DUT}.root -t configs/globalorig.cfg -r $TELECONF -d configs/$DUTCONFIG -R DUT-alignment-result.root #-n 50000 #-n 50000
