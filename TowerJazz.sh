...
#export ALIG=$PATHA/cosmic_033217_000000.root
export ALIG=$PATHA/cosmic_033217_000000.root
...
export DUT=$PATHA/run_33219_tj_W3R15_M106_6V_3DRS_fft12
#export DUT=$PATHA/run_33118_tj_W3R15_M129_6V_3DRS_fft10
#export DUT=$PATHA/run_33234_tj_W3R13_M60_6V_3DRS_fft12
...
export RCE=$PATHA/cosmic_033219_000000
#export RCE=$PATHA/cosmic_033234_000000
#export RCE=$PATHA/cosmic_033072_000000
...
echo "-------------------Apply mask"
./Judith -c applyMask -i $RCE.root -o ${RCE_MASKED}.root  -r $TELECONF -t configs/globalorig_TowerJazz.cfg 
...
./Judith -c synchronizeBunchXing -i ${RCE_MASKED}.root -o ${RCE_MASKED}_sync.root -I $DUT.root -O ${DUT}_sync.root -r $TELECONF -d configs/$DUTCONFIG -t configs/globalorig_TowerJazz.cfg 
...
./Judith -c coarseAlign -i $ALIG -r $TELECONF -t configs/globalorig_TowerJazz.cfg 

echo "-------------------FineAlign telescope"
./Judith -c fineAlign -i $ALIG -r $TELECONF -t configs/globalorig_TowerJazz.cfg -R ${ALIG}-alignment-result.root 
...
echo "-------------------FineAlign dut"
./Judith -c fineAlignDUT -i ${RCE_MASKED}.root -I ${DUT}.root -t configs/globalorig.cfg -r $TELECONF -d configs/$DUTCONFIG -R DUT-alignment-result.root 
...
./Judith -c process -i ${RCE_MASKED}.root -o ${RCE_PROCC}.root -r $TELECONF -t configs/globalorig_TowerJazz.cfg -R ${RCE}-proccess-result.root 
echo "-------------------process dut"
...
./Judith -c analysis -i ${RCE_PROCC}.root -r $TELECONF -t configs/globalorig.cfg -R ${RCE}-analysis-result.root 
echo "-------------------Analysis dut"
./Judith -c analysisDUT -i ${RCE_PROCC}.root -I ${DUT_PROCC}.root -r $TELECONF -d configs/$DUTCONFIG -t configs/globalorig_TowerJazz.cfg -R ${DUT}-analysis-result.root
